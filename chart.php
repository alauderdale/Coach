...
<div class="container-bg">
    <div class="wrapped main chart">
        <h1>FasCat Coaching Plans </h1>
        <h2>Whether you&apos;re a pro or you&apos;re just starting out&comma; FasCat has a plan<br/> that works for you. </h2>
        <div class="chart-inner">
            <div id="usual2" class="usual"> 
                  <ul class="tabs"> 
                    <li><a href="#tabs1" class="selected">Coaching</a></li> 
                      ...
                      <div class="chart-content">
                         <div class="pricing">
                             ...
                             <div class="pricing-square level t-one five-col">
                                 <h1>Level 1</h1>
                                 <h2>Cost/4 week <br/> training block</h2>
                                 <h3>$150</h3>
                             </div>
                             <div class="pricing-square level t-one five-col">
                                 <h1>Level 2</h1>
                         ...
                         </div><!--end level disclaimer-->
                         <table class="chart-table">
                             <tr>
                                 <td class="first-d">    
                                     <span>                                         
                                         Cost /4 week <br/> training block
                                     </span>
                                 </td>
                                 <td class="bolder">
                                     $150
                             ...
                             <tr>
                                 <td class="first-d" >
                                     <span>
                                     Off Season <br/> Training Program
                                     </span>
                                 </td>
                                 <td class="bolder">
                                     X
                  ...
                  <div id="tabs2" style="display: none; ">
                      <div class="chart-content">
                         <div class="pricing">
                             <div class="pricing-square four-col">
                                 <h1>
                                     Need help in figuring out what level is right for you?
                                 </h1>
                                 <p>Give us a call at</p>
                         ...
                         <table class="chart-table table-two">
                             <tr>
                                 <td class="first-d">    
                                     <span>                                         
                                         Cost /4 week <br/> training block
